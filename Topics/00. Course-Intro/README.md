...
# High-Quality Code - Part II:<br/>Course Introduction
## Course Program, Evaluation,<br/> Exams, Resources
...
<!-- attr: { showInPresentation:true, hasScriptWrapper:true } -->
# What's Coming Next?
- High-Quality Code - Part II
  - Continuation of HQC - Part I
  - Defensive programming, Code tuning and optimization, Refactoring, Debugging, Software engineering fundamentals, Development tools, QA Fundamentals
...
<!-- # <a id="hqcprogram"></a> High-Quality Code - Part II <br/> Course Program
...
- http://academy.telerik.com/student-courses/programming/high-quality-code-part-2/about
...
- http://telerikacademy.com/Courses/Courses/Details/349
...
<!-- attr: { showInPresentation:true, hasScriptWrapper:true } -->
<!-- # HQC - Part II:<br/> Course Introduction -->
